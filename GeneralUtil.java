...
public class GeneralUtil {	
	...
	public static Boolean isDstAsID = false;
	...
	public static String dataSummaryForFlowSize = "\\G:\\GeneralFramework\\result\\srcDst_size_output1.txt"; //path + "traffic\\CAIDA_data0_statistics_size.txt";
	public static String dataStreamForFlowSpread = "\\G:\\GeneralFramework\\dst_spread_output1.txt"; //path + "traffic\\10MPackets.txt";
	public static String dataSummaryForFlowSpread = "\\G:\\GeneralFramework\\result\\dst_spread_output1.txt";
	...
	//-----the following bin is for bitmap---
		public static ArrayList<Integer> bin = new ArrayList<>(Arrays.asList(1,2,4,6,8,16,32,64, 128, 256,512,750,1024,4000,8000,20000,32768,32768*2,32768*4,32768*8,32768*16,32768*32,10000000));
